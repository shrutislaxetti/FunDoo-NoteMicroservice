...
public class LabelServiceImpl implements LabelService {
	...
	public List<LabelDTO> getAllLabel(String userId) throws LabelNotFoundException, ElasticsearchFailException {
		List<Label> labelList = labelElasticRepository.findAllByUserId(userId);
	...
	public void updateLabel(String userId, String labelId, String labelName)
		...
		Optional<Label> optionalLabel = labelElasticRepository.findByLabelIdAndUserId(labelId, userId);
	...
	public List<NoteDTO> getLabel(String userId, String labelId)
		...
		List<Note> noteList = noteElasticRepository.findAllByUserIdAndTrash(userId, false);
