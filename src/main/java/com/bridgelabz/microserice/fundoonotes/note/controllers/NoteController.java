...
public class NoteController {
	...
	public ResponseEntity<Response> updateNote(HttpServletRequest request, @PathVariable String noteId,
			...
			throws NoteException, NoteNotFoundException, UnauthorizedException, ReminderException, ParseException, GetLinkInfoException, ElasticsearchFailException, LinkInformationException {
