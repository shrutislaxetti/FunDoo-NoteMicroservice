...
public class NoteMicroServiceApplicationTests {
	...
	public void setup() throws JsonParseException, JsonMappingException, IOException {
		...
		casesFile = new ClassPathResource("LabelTestCase.json");
	...
	public void test1() throws Exception {
		Json json = cases.get("Label_SuccessFulCreation_test");
		successfulNote(json);
	}

   @Test
	public void test2() throws Exception {
		Json json = cases.get("Label_NullLabelName_test1");
		test(json);
	}
	...
	private void successfulNote(Json json) throws Exception {
